...
let Score          = 0;
   ...
   const QuizList  = {
    0: {
        ...
        QuestionList: [
        {    
            question: "Q1. What is the real name of Pain that Naruto fought in the leaf village?",
            Option  : ["A: Kakuza", "B: Nagato", "C: Kabuto", "D: Hiraku"],
            Answer  : "B: Nagato"
        },
        {
            question: "Q2. who is the main protagonist in the anime 'attack on titan'?",
            Option  : ["A: Eren Yeager"," B: Mikasa Ackerman", "C. Levi Ackerman", "D. Armin arlert"],
            Answer  : "A: Eren Yeager" 
        },
        {
            question: "Q3. Which anime features a character named Monkey D. Luffy who aims to become the pirate King?",
            Option  : ["A: Fairy Tail", "B: One piece", "C: Black Clover", "D: My hero Academia"],
            Answer  : "B: One piece"
        },
        {
            question: "Q4. Who does Levi term up with to recuse Eren from the female Titan 'Attack on Titan'?",
            Option  : ["A: Kitz Weilman", "B: Jean kirshtien", "C: Mikasa Ackerman", "D: Dot Pyxis"],
    ...
    1: {
        ...
        QuestionList:[
        {
            question: "Q1. Which country Won the first-ever Cricket World cup in 1975?",
            Option  : ["A: India", "B: England", "C: Australia", "D: West Indies"],
            Answer  : "D: West Indies"
        },
        {
            question: "Q2. Who Holds the record for the highest Individual score in Test Cricket?",
            Option  : ["A: Sachin Tendulkar", "B: Brian Lara", "C: Don Bradman", "D: Ricky Ponting"],
            Answer  : "B: Brian Lara"
        },
        {
        ...
        {
            question: "Q4. Who holds the record for the Fastest century in One Day International?",
            Option  : ["A: Chirs Gayle", "B: virat Kholi", "C: AB de villers", "D: Rohit Shrama"],
    ...
    2: {
       categoryName: "Coding",
        QuestionList: [
        {
            question: "Q1. Which of the Dialog Box Display a Message and a data Entry Field",
            Option  : ["A: Alert()", "B: Prompt()", "C: Confirm()", "D: MSG()"],
            Answer  : "B: Prompt()"
        },
        {
            question: "Q2. If ____ Button is clicked ....Event handler is invoked",
            Option  : ["A: OnSubmit()", "B: OnLoad()", "C: IsPostBack()", "D: OnClick()"],
            Answer  : "D: OnClick"
        },
        {
        ...
        },
        {
            ...
            Option  : ["A: Function/Method", "B: RMI", "C: Triggering Event", "D: Preprocessor"],
...
function fillElmt() {
    ...
    for(let j = 0; j < Option.children.length; j++){
        Option.children[j].textContent = QuizList[categoryIndex].QuestionList[index].Option[j];   
    }
}
